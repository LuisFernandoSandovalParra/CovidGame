...
public class PanelLose extends JPanel {
	...
	private static final String GIF_PC_BACKGROUND_LOSE = "/img/gameOverBackgroundFive.gif";
	...
	private static final String IMG_LOGO_TWO_PIXEL = "/img/gameOver.gif";
	private static final long serialVersionUID = 1L;
	private JTextField userField;

	public PanelLose(ActionListener actionListener) {
	...
	public void paint(Graphics g) {
		g.drawImage(new ImageIcon(getClass().getResource(GIF_PC_BACKGROUND_LOSE)).getImage(), 0, 0, getWidth(),
				getHeight(), this);
		setOpaque(false);
		super.paint(g);
	}
